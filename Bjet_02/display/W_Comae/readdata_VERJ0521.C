{
  ...
  int i, n0=108, n0_0=58,n0_1=7, n1a_2=43,n1a_3=8,n2=32,n2_1=9,n2_2=4,n2_3=6,n2_4=8,n2_5=5,nb0,nb1,nb2,nb3,n_Vb = 50;
  ...
  const double planck = 4.135667517e-15; // h in [eV s]
   ...
   //file_VERITAS.open("data/W_Comae/VERITAS_butterfly_low.dat");
...
//******************************************************************
	...
	gr0->Draw("AP");
	gr0->SetTitle("PKS_0625-354 Data");
