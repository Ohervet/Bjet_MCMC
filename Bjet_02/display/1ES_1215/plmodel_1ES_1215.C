...
// Make Plots
 ...
 // 1. Particle spectra
   ...
   graph1->SetTitle("Particle spectra post flare; log (#gamma); log (#rho [particle cm^{-3}] )");
...
*/
 ...
 /*
    ...
    */
	...
	leg = new TLegend(0.13,0.78,0.95,0.85);
	...
	leg->AddEntry(gr_xrt,"Swift-XRT","lep");
        ...
        leg->AddEntry(gr_F,"Fermi-LAT","lep");
        leg->AddEntry(gr_V,"VERITAS","lep");
        leg->AddEntry(gr0,"#splitline{2017 flare:}{Fermi-LAT & VERITAS}","lep");
        */
    ...
    //TText *tt = new TText(16.5,-9.75,"2017 flare");
    TText *tt = new TText(15.5,-9.8,"2017 flare");
    tt->SetTextColor(14); 
    tt->SetTextSize(0.02);
    tt->Draw();
    //TText *tt = new TText(15.2,-10.227,"2017 post-flare");

    TText *tt = new TText(14.4,-10.3,"2017 post-flare");
    tt->SetTextColor(14); 
    tt->SetTextSize(0.02);
    tt->Draw();	
