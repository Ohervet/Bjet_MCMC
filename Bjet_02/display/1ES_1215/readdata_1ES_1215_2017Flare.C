{
  ...
  int i, count, countUL, n0=12,n1=194,nb0,nb1, gr0_0, nfs = 50, nVs = 50;
...
/*
  ...
  const double planck = 4.135667517e-15; // h in [eV s]
   ...
   file0.open("data/1ES_1215+303/1ES1215_Flare2017_SED.dat");
   file1.open("data/1ES_1215+303/1ES1215_Postflare2017_SED.dat");
   file_VERITAS.open("data/1ES_1215+303/VERITAS_Flare2017_spectrum.dat");
