{
  ...
  int i, count, countUL, nb0, nb1, gr0_0;
  const Int_t n0=70,n1=51,n2=32,nfs = 50, nVs = 800;
  ...
  const double planck = 4.135667517e-15; // h in [eV s]
   ...
   file1.open("data/OJ_287/OJ287_SED_radio_archival.dat");
   file0.open("data/OJ_287/OJ287_PostFlare_SED.dat");
   file_Fermi.open("data/OJ_287/Fermi_spectrum_PostFlare.dat");
   file_VERITAS.open("data/OJ_287/VERITAS_spectrum_PostFlare.dat");
...
//******************************************************************
	...
	// Host galaxy
        if(nb_g>0){
          TGraph *gr10 = new TGraph(nb_g,freq_g,fflux_g);
	  gr10->SetLineColor(2);
          gr10->SetLineStyle(1);
	  //gr10->Draw("C");
        }
