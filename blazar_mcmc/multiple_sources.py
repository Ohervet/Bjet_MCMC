...
three = True
#backend_1 = "results/b1_no_eic/3C66A_b1_no_eic_2022-06-08-10:41:49/backend.h5"
#backend_2 = "results/b1_no_eic/3C66A_b1_no_eic_cont_2022-06-09-17:47:13/backend.h5"

name_stem = "stem_b6_no_eic"
folder = "results/b6_no_eic"
backend_1 = "results/b6_no_eic/3C66A_b6_no_eic_2022-06-10-13:41:53/backend.h5"
backend_2 = "results/b6_no_eic/3C66A_b6_no_eic_cont_2022-07-02-22:02:42/backend.h5"
backend_3 = "results/b6_no_eic/3C66A_b6_no_eic_cont2_2022-07-03-23:16:54/backend.h5"
...
if three:
    folder3 = backend_3[:backend_3.rfind('/')]
...
if three:
    reader3 = emcee.backends.HDFBackend(BASE_PATH + backend_3)
...
if three:
    chain3 = reader3.get_chain()
    flat_samples3 = reader3.get_chain(flat=True)
    log_probs3 = reader3.get_log_prob()
    flat_log_probs3 = reader3.get_log_prob(flat=True)


    chain = np.concatenate((chain1, chain2, chain3))
    flat_chain = np.concatenate((flat_samples1, flat_samples2, flat_samples3))
    flat_samples = flat_chain
    log_probs = np.concatenate((log_probs1, log_probs2, log_probs3))
    flat_log_probs = np.concatenate((flat_log_probs1, flat_log_probs2, flat_log_probs3))
else:
...
info = blazar_report.parse_info_doc(folder1 + "/basic_info.txt")
...
blazar_report.save_plots_and_info(configs, (v_data, vFv_data, err_data), param_min_vals, param_max_vals, folder=folder, samples=(chain, flat_samples, log_probs, flat_log_probs), use_samples=True, redshift=0.340, eic=eic)
